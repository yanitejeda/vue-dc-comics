  ...
  <div>
    <div class="dark-content">
      ...
      <div class="container">
        ...
        <ProductCard  v-for="(item, i) in cardItem" :key="i"
        ...
        <!-- 
          <div class="product-card" v-for="(item, i) in cardItem" :key="i">
            <div class="box-url">
...
<!-- parte blu -->
    <div class="bar-icon-main ">
      <div class="container list-group ">

      <GroupItem v-for="(item,i) in blueIcon" :key="i"
      :img='item.picture'
      :tittle='item.tittle'
      >
      </GroupItem>
     ...
     <!--  <ul class="list-group container">
        <div>
          <img
            src=""
            alt=""
            v-for="(item, i) in blueIcon"
            :key="i"
          />
        </div>
        <li class="icon-blu-main" v-for="(item, i) in blueIcon" :key="i">
          {{ item.tittle }}
        </li>
      </ul> -->
    </div>
      ...
      blueIcon: [
        {
          ...
          tittle: "DIGITA COMICS",
        },
        {
          picture: "buy-comics-merchandise.png",
          tittle: "DC MERCHANDISE",
        },
        {
